...
- **3.1** — команда `/trade mode sim|live` с защитой PIN (ADMIN_KEY).
- **3.2** — исправлена обработка PIN для `/trade`: другие команды продолжают работать, когда смена режима не запрошена.
